...
[$script, $connectionName, $invoiceUuid, $version, $correlationUuid, $encodedPayload, $barrier] = $argv + array_fill(0, 7, null);
...
$payload = json_decode((string) base64_decode((string) $encodedPayload, true), true, 512, JSON_THROW_ON_ERROR);

try {
    $app->make(InvoiceDraftEditor::class)->update(
        (string) $invoiceUuid,
        (int) $version,
