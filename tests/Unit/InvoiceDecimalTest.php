...
class InvoiceDecimalTest extends TestCase
{
    ...
    #[DataProvider('displayMoneyValues')]
    public function test_money_display_uses_czech_format_without_database_scale(string $value, string $currency, string $expected): void
    {
        $this->assertSame($expected, InvoiceDecimal::formatMoney($value, $currency));
    }
